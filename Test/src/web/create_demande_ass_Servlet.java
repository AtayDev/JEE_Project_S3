...
public class create_demande_ass_Servlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("create_demande_ass.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		///////////////////////////////////////////////////////////////////
		 demande=demDao.insertDemande(new Demande(demandeur_id,titre,ville,description,dateDebut,dateFin,dbFileName,savePath,Statut,Type,adresseBenevolat, montantBut,nbBenevolesBut,heureDebut,adresseBenevolat));
